...
w <- world(path=".")
geo <- do.call(rbind, lapply(1:length(dd), \(i) data.frame(Group=groups[i], dd[[i]][, c("longitude", "latitude")]))) |> unique()
geo <- na.omit(geo)
