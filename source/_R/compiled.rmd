...
terra::plot(g, col=gray(.95), background="azure", lwd=1.5, mar=c(.4, .2, 0, 0), lab.cex=.4)
terra::plot(w, add=TRUE, col="light gray", border="white", lwd=1.5)
terra::points(v, col="pink", cex=.5)
terra::points(v, col="red", cex=.25)
terra::lines(w, col="dark gray", lwd=1)
terra::halo(-12000000, -6500000, paste("Carob locations\n  ", cdate), xpd=TRUE, cex=.6)
``` 
...
knitr::kable(x, "html", escape=FALSE, align = "lrrrr") |>
