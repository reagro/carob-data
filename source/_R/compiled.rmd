...
**NOTE: The data download will not work between June 16 and June 20. Sorry for the inconvenience.**
...
Below, you can download the compiled standardized data by group. If you want all data, select "everything". If you want data for a single data set, you can find these [here](done.html). Please note that for most survey data, we have currently only partially processed the data, and the original data sources may contains many more variables.
</br>
