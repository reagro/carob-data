...
get_authors <- function(d) {
	...
	p <- p[!grepl("ABC|International Center|Alliance of Bioversity|CIAT|Institut|ILRI|IFPRI|IRRI|IWMI|CIMMYT|ICRISAT|IITA|ICRAF|ISRIC|LUANAR|TARI|University of California|MSU|Ministry of Food and Agriculture (MOFA), Republic of Ghana|SARI|Sokoine University|ZARI|CRS|TLC|Wageningen", p$p), ]
	p$p <- gsub("  ", " ", p$p)
	p$p <- trimws(p$p)
	p <- p[p$p !="", ]
